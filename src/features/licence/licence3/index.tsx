...
export const Licence3 = () => {
    ...
    // Utiliser le hook corrigé pour filtrer les étudiants de niveau L3
    const {
        filteredStudents,
    ...
    usePageTitle(
        isTableEditable ? "Edition des notes de Licence 3" : "Notes Licence 3"
    );
        ...
        return (
            <div className="text-center py-8">
                <h2 className="text-xl font-semibold text-gray-600 mb-4">
                    Aucune matière assignée pour le niveau Licence 3
                </h2>
                ...
                {hasStudents && (hasAtLeastOneGrade || showTable) ? (
                    ...
                    <div className="text-center py-8">
                        <p className="text-gray-500 text-lg">
                            Aucun étudiant de niveau Licence 3 ne suit vos cours.
                        </p>
