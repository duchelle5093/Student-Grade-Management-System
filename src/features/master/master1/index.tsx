...
export const Master1 = () => {
    ...
    // Utiliser le hook corrigé pour filtrer les étudiants de niveau M1
    const {
        filteredStudents,
        ...
        currentLevel: AcademicLevel.LEVEL4
    });
    ...
    usePageTitle(
        isTableEditable ? "Edition des notes de Master 1" : "Notes Master 1"
    );
                ...
                {hasStudents && (hasAtLeastOneGrade || showTable) ? (
                    ...
                    <div className="text-center py-8">
                        <p className="text-gray-500 text-lg">
                            Aucun étudiant de niveau Master 1 ne suit vos cours.
                        </p>
