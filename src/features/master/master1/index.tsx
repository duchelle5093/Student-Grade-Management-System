...
export const Master1 = () => {
    ...
    const { filteredStudents, teacherSubjectsForLevel } = useFilteredStudents({
        currentLevel: AcademicLevel.LEVEL4, // Master 1
    });
    ...
    usePageTitle(isTableEditable ? "Edition des notes de Master 1" : "Notes Master 1");
    ...
    /** FLOW CORRECT: TOUS les étudiants M1 + leurs notes pour la matière sélectionnée */
        ...
        return (
            <div className="text-center py-8">
                <h2 className="text-xl font-semibold text-gray-600 mb-4">
                    Aucune matière assignée pour le niveau Master 1
                </h2>
    ...
    if (filteredStudents.length === 0) {
        return (
            <div className="text-center py-8">
                <h2 className="text-xl font-semibold text-gray-600 mb-4">
                    Aucun étudiant trouvé en Master 1
                </h2>
                <p className="text-gray-500">
