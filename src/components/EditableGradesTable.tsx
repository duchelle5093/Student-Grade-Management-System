...
export const EditableGradesTable = ({
  ...
  const baseColumns = [
    ...
    },
    {
      ...
      sorter: (a: studentResDto, b: studentResDto) => {
        const totalA =
          (Number(a.cc1) || 0) + (Number(a.tp) || 0) + (Number(a.sn1) || 0);
        const totalB =
          (Number(b.cc1) || 0) + (Number(b.tp) || 0) + (Number(b.sn1) || 0);
  ...
  const gradeFields = [
    ...
    "tp2",
    "sn2",
    ...extraColumns.map((col) => col.dataIndex),
  ];
    ...
    <div>
      ...
      <div className="flex justify-between mt-4 w-full">
        ...
        <div>
          ...
          >
            {attributedGrades} notes attribuées pour {FakeStudents.length}{" "}
            étudiants
          </Tag>
        </div>
      </div>
